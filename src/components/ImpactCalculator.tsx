    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
          ...
          <div className="lg:col-span-6 rounded-3xl border border-slate-200 bg-slate-50/70 p-8 sm:p-10 shadow-xs flex flex-col justify-between">
            <div>
          ...
          <div className="lg:col-span-6 rounded-3xl border border-blue-900/60 bg-[#0A192F] text-white p-6 sm:p-10 flex flex-col justify-between shadow-2xl min-w-0 overflow-hidden">
            <div className="min-w-0">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                <div className="p-4 sm:p-5 rounded-2xl bg-[#071326] border border-blue-900/60 min-w-0 overflow-hidden">
